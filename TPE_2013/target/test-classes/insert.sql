...
INSERT INTO restaurants (id, name, address, area, telephone, website, timerange, avgprice, foodtypeid, avgscore, cantratings) VALUES (10, 'Cocina Japonesa', 'Av Eduardo Madero 399, Buenos Aires, Argentina', 'Villa Crespo', '4856-1250', 'www.cj.com', '06 a 19', 70, 4, 3, 1);
INSERT INTO restaurants (id, name, address, area, telephone, website, timerange, avgprice, foodtypeid, avgscore, cantratings) VALUES (11, 'Cocina China', 'Av Eduardo Madero 399, Buenos Aires, Argentina', 'Agronomia', '4667-1255', 'www.cc.com', '08 a 23', 40, 3, 2.6666666666666665, 3);
INSERT INTO restaurants (id, name, address, area, telephone, website, timerange, avgprice, foodtypeid, avgscore, cantratings) VALUES (7, 'La rosadita', 'Av Eduardo Madero 399, Buenos Aires, Argentina', 'Palermo', '4503-2332', 'www.larosadita.com', '12 a 18', 75, 11, 3, 1);
INSERT INTO restaurants (id, name, address, area, telephone, website, timerange, avgprice, foodtypeid, avgscore, cantratings) VALUES (6, 'Kentucky', 'Av Eduardo Madero 399, Buenos Aires, Argentina', 'Palermo', '4503-1233', 'www.kentucky.com', '08 a 23', 40, 13, 2.25, 4);
INSERT INTO restaurants (id, name, address, area, telephone, website, timerange, avgprice, foodtypeid, avgscore, cantratings) VALUES (5, 'Subway', 'Av Eduardo Madero 399, Buenos Aires, Argentina', 'Centro', '5555-2144', 'www.subway.com', '14 a 24', 40, 12, 2, 2);
INSERT INTO restaurants (id, name, address, area, telephone, website, timerange, avgprice, foodtypeid, avgscore, cantratings) VALUES (4, 'Maizales', 'Av Eduardo Madero 399, Buenos Aires, Argentina', 'Caballito', '4585-3434', 'www.maizales.com', '11 a 16', 85, 7, 4, 1);
INSERT INTO restaurants (id, name, address, area, telephone, website, timerange, avgprice, foodtypeid, avgscore, cantratings) VALUES (3, 'Burger King', 'Av Eduardo Madero 100, Buenos Aires, Argentina', 'Centro', '4555-6554', 'www.burger.com', '12 a 22', 25, 12, 3.5, 2);
INSERT INTO restaurants (id, name, address, area, telephone, website, timerange, avgprice, foodtypeid, avgscore, cantratings) VALUES (2, 'MC Donalds', 'Av Eduardo Madero 10, Buenos Aires, Argentina', 'Centro', '4555-5555', 'www.mc.com', '10 a 22', 30, 12, 1, 1);
INSERT INTO restaurants (id, name, address, area, telephone, website, timerange, avgprice, foodtypeid, avgscore, cantratings) VALUES (1, 'Rodizio', 'Av Eduardo Madero 399, Buenos Aires, Argentina', 'Palermo', '4509-2201', 'www.careta.com', '5 a 7', 450, 1, 4, 1);
INSERT INTO restaurants (id, name, address, area, telephone, website, timerange, avgprice, foodtypeid, avgscore, cantratings) VALUES (12, 'Los platitos', 'Av Eduardo Madero 399, Buenos Aires, Argentina', 'Costanera', '4553-1540', 'www.lp.com', '08 a 24', 130, 1, 3, 2);
INSERT INTO restaurants (id, name, address, area, telephone, website, timerange, avgprice, foodtypeid, avgscore, cantratings) VALUES (8, 'El club de la milanesa', 'Av Eduardo Madero 399, Buenos Aires, Argentina', 'Palermo', '4503-3256', 'www.cblm.com', '06 a 12', 70, 11, 4, 2);
INSERT INTO restaurants (id, name, address, area, telephone, website, timerange, avgprice, foodtypeid, avgscore, cantratings) VALUES (9, 'Sushi Pop', 'Av Eduardo Madero 399, Buenos Aires, Argentina', 'Belgrano', '4333-1233', 'www.sushipop.com', '18 a 23', 120, 14, 2, 1);
