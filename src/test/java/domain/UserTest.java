...
public class UserTest {
	...
	public void init() {
		...
		User user = new User("a", "a", "aa@aa.aa", "a", "a", picture,
		...
		Restaurant restaurant = new Restaurant("a", "a", "a", "a", "a", "a", 1,
				RestaurantState.Accepted, set, user, new Date());
	...
	public void newValidUserTest() {
		...
		User user = new User("name", "surname", "email@email.com", "username",
				"password", picture, new Date(), UserType.Normal);
	...
	public void nullNameTest() {
		...
		User user = new User(null, "surname", "email@email.com", "username",
				"password", picture, new Date(), UserType.Normal);
	}
	...
	public void nullSurnameTest() {
		...
		@SuppressWarnings("unused")
		User user = new User("name", null, "email@email.com", "username",
				"password", picture, new Date(), UserType.Normal);
	}
	...
	public void nullEmailTest() {
		...
		@SuppressWarnings("unused")
		User user = new User("name", "surname", null, "username", "password",
				picture, new Date(), UserType.Normal);
	}
	...
	public void nullUsernameTest() {
		...
		@SuppressWarnings("unused")
		User user = new User("name", "surname", "email@email.com", null,
				"password", picture, new Date(), UserType.Normal);
	}
	...
	public void nullPasswordTest() {
		...
		@SuppressWarnings("unused")
		User user = new User("name", "surname", "email@email.com", "username",
				null, picture, new Date(), UserType.Normal);
	}
	...
	public void nullPictureTest() {
		...
		@SuppressWarnings("unused")
		User user = new User("name", "surname", "email@email.com", "username",
				"password", null, new Date(), UserType.Normal);
	}
	...
	public void nullDateTest() {
		...
		@SuppressWarnings("unused")
		User user = new User("name", "surname", "email@email.com", null,
				"password", picture, null, UserType.Normal);
	}
	...
	public void emptyNameTest() {
		...
		@SuppressWarnings("unused")
		User user = new User("", "surname", "email@email.com", "username",
				"password", picture, new Date(), UserType.Normal);
	}
	...
	public void emptySurnameTest() {
		...
		@SuppressWarnings("unused")
		User user = new User("name", "", "email@email.com", "username",
				"password", picture, new Date(), UserType.Normal);
	}
	...
	public void emptyUsernameTest() {
		...
		@SuppressWarnings("unused")
		User user = new User("name", "surname", "email@email.com", "",
				"password", picture, new Date(), UserType.Normal);
	}
	...
	public void isAdministratorTest() {
		...
		User user = new User("name", "surname", "email@email.com", "username",
				"password", picture, new Date(), UserType.Admin);
	...
	public void invalidEmailTest() {
		...
		@SuppressWarnings("unused")
		User user = new User("name", "surname", "berhsdfbdhj", "username",
				"password", picture, new Date(), UserType.Normal);
	}
